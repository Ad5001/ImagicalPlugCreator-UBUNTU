...
UBUNTU_TRANSLATION_DOMAIN="imagicalplugcreator.ad5001"
...
aptest.commands = bash $$PWD/ImagicalPlugCreator/tests/autopilot/run
aptest.depends  = sub-ImagicalPlugCreator

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/ImagicalPlugCreator/tests/unit 
unittest.depends  = sub-ImagicalPlugCreator
